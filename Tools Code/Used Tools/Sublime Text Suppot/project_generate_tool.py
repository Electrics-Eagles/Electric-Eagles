...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.projectNameLabel)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.projectNameLineEdit)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.controllerTypeLabel)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.controllerTypeComboBox)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.cOMPortComboBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Create Project"))
