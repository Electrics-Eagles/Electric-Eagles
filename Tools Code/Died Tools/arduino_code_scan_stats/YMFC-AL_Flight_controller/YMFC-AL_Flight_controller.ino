...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float pid_p_gain_roll = 0.01;               //Gain setting for the roll P-controller
...
float pid_p_gain_yaw = 0.01;                //Gain setting for the pitch P-controller. //4.0
...
void loop() {
  ...
  if (start == 2) {                                                         //The motors are started.
    ...
    if (esc_1 < 1300) esc_1 = 1300;                                         //Keep the motors running.
    if (esc_2 < 1300) esc_2 = 1300;                                         //Keep the motors running.
    if (esc_3 < 1300) esc_3 = 1300;                                         //Keep the motors running.
    if (esc_4 < 1300) esc_4 = 1300;                                         //Keep the motors running.
    ...
    esc_1 = 1200;                                                           //If start is not 2 keep a 1000us pulse for ess-1.
    esc_2 = 1200;                                                           //If start is not 2 keep a 1000us pulse for ess-2.
    esc_3 = 1200;                                                           //If start is not 2 keep a 1000us pulse for ess-3.
    esc_4 = 1200;                                                           //If start is not 2 keep a 1000us pulse for ess-4.
  }
