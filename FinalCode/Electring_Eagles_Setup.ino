...
#define U1 12
#define U2 12
UltraSonicDistanceSensor distanceSensor(U1, U2);  // Initialize sensor that uses digital pins 13 and 12.
...
{
  Serial.println(F("==================================================="));
  Serial.println(F("Ultrasonics setup"));
  Serial.println(F("==================================================="));
  Serial.println(F("Checking ultrasonic now...................."));
  if (distanceSensor.measureDistanceCm() > 1 &&  distanceSensor.measureDistanceCm()  < 300)
  {
    error = 0;
    Serial.println(F("Sucessful checked utrasonic sensor"));
    Serial.println(F("==================================================="));
    Serial.println(F("Ultrasonics setup .... OK"));
    Serial.println(F("==================================================="));
    Serial.println(F("Checking ultrasonic now....................OK"));
  }
  else {
    error = 1;
    Serial.println(F("[ERROR 9 ] Check Utrasonic sensor"));
  }
...
void loop() {
  ...
  if (error == 0) {
    Serial.println(F("Well done copter calibrated. Now we can upload main Firmware...."));
    Serial.println(" █▀▀ █░░ █▀▀ █▀▀ ▀▀█▀▀ █▀▀█ ░▀░ █▀▀   █▀▀ █▀▀█ █▀▀▀ █░░ █▀▀ █▀▀");
    Serial.println(" █▀▀ █░░ █▀▀ █▀▀ ▀▀█▀▀ █▀▀█ ░▀░ █▀▀   █▀▀ █▀▀█ █▀▀▀ █░░ █▀▀ █▀▀");
    Serial.println(" █▀▀ █░░ █▀▀ █░░ ░░█░░ █▄▄▀ ▀█▀ █░░   █▀▀ █▄▄█ █░▀█ █░░ █▀▀ ▀▀█");
    Serial.println(" ▀▀▀ ▀▀▀ ▀▀▀ ▀▀▀ ░░▀░░ ▀░▀▀ ▀▀▀ ▀▀▀   ▀▀▀ ▀░░▀ ▀▀▀▀ ▀▀▀ ▀▀▀ ▀▀▀");
    Serial.println(F("==================================================="));
    Serial.println(F("For support and questions: sahsariga111@gmail.com"));
    Serial.println(F("==================================================="));
  }
  else {
    Serial.println(F("The setup is aborted due to an error."));
    Serial.println(F("Ask in sahsariga111@gmail.com or here "));
  }
  while (1);
}
...
void intro() {
  ...
  Serial.println(F(""));
  Serial.println(F("YMFC-AL Setup Program based..... "));
  Serial.println(F(""));
  Serial.println(F("==================================================="));
  Serial.println(F(""));
  Serial.println(" █▀▀ █░░ █▀▀ █▀▀ ▀▀█▀▀ █▀▀█ ░▀░ █▀▀   █▀▀ █▀▀█ █▀▀▀ █░░ █▀▀ █▀▀");
