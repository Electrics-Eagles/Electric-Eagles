...
//Edited by Electrics Eagles
///////////////////////////////////////////////////////////////////////////////////////
/*
  Core Electrics Eagles Code
...
#include <EEPROM.h>
#include "Varibles.h" // All varibles now is migrated here . 
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Declaring global variables
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

void buzzer_signal(int type, int pin) {
  if (type == 1) // Loading started
  {
  ...
  if (type == 2)
  {
    for ( int loops = 0; loops < 40; loops++ )// Load finished
    {
      digitalWrite(pin, HIGH);
      delay(100);
      digitalWrite(pin, LOW);
  ...
  if (type == 3)
  {
    for ( int loops = 0; loops < 20; loops++) // Some Error
    {
      digitalWrite(pin, HIGH);
      delay(200);
      digitalWrite(pin, LOW);
  ...
  if (type == 4)
  {
    for ( int loops = 0; loops < 10; loops++) // Battary low
    {
      digitalWrite(pin, HIGH);
      delay(500);
      digitalWrite(pin, LOW);
...
void manual_control_logo() {
  if (MANUAL_API_LOGO == 1) {
    Serial.println(F("_________________________________________MANUAL API ________________________________________________"));
    Serial.println(F("Manual API Demo   "));
    Serial.println(F("Instruction : Channel 1 Value , Channel 2 Value , Channel 3 Value , Channel 4 Value "));
    Serial.println(F("Channel  Value it is a number between 1000 and 2000"));
    Serial.println(F("Example: 1000 1001 1002 1003 where a 1000 is channel 1 value , where is a  1001 channel 2 value,where is a  1002 channel 3 value,where is a  1003 channel 4 value"));
    Serial.println(F(" It is a full Manual IP "));
    Serial.println(F("_________________________________________MANUAL API ________________________________________________"));
...
//Setup routine
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void get_ready_to_takeoff(void) {
  pinMode(13, OUTPUT);
  buzzer_signal(1, 13);
  if (DEBUG == 1) {
    Serial.begin(115200);
    ...
    Serial.println(F(" █▀▀ █   █▀▀ █     █   █▄▄▀ ▀█▀ █     █▀▀ █▄▄█ █ ▀█ █   █▀▀ ▀▀█"));
    Serial.println(F(" ▀▀▀ ▀▀▀ ▀▀▀ ▀▀▀   ▀   ▀ ▀▀ ▀▀▀ ▀▀▀   ▀▀▀ ▀  ▀ ▀▀▀▀ ▀▀▀ ▀▀▀ ▀▀▀"));
    Serial.println(F(" Kernel Verison v1.0.1 12/09/2019 based on http://www.brokking.net/ymfc-al_main.html "));
    Serial.println(F("Manual API Verison v1.0.0 10/09/2019"));
    Serial.println(F("API and some editions code in kernel are author`s Alex Zaslavskis, Mike Zaslavskis , Danio Zile"));
  }
  manual_control_logo();
  ...
  //, HIGH);                                                   //Turn on the warning led.

  //Check the EEPROM signature to make sure that the setup program is executed.
  while (eeprom_data[33] != 'E' || eeprom_data[34] != 'L' || eeprom_data[35] != 'E')delay(10);
