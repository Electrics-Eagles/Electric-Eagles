...
///////////////////////////////////////////////////////////////////////////////////////
float gps_roll_adjust, gps_pitch_adjust;
...
double latiude, latiude_now;
float long_error, lat_error;
float long_error_buffer, lat_error_buffer;
float gps_pitch_adjust_north, gps_roll_adjust_north;
float gps_p_gain = 2.7;
float gps_d_gain = 6.5;
boolean latitude_north, longiude_east;
float angle_yaw;
unsigned long gps_milis = 0;        // will store last time LED was updated
const long gps_interval = 1000;           // interval at which to blink (milliseconds)
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Setup routine
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void setup() {
...
void loop() {
  ...
  pid_roll_setpoint += gps_roll_adjust;
  ...
  pid_pitch_setpoint += gps_pitch_adjust;
