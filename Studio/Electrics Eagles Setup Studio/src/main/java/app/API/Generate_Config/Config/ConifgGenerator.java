package app.API.Generate_Config.Config;
...
import static app.API.Varibles_Java.Variables.Drone_Gyro;
import static app.API.Varibles_Java.Variables.Props_Size;
...
public class ConifgGenerator {
 ...
 public static void  generate_config_file() throws IOException {
     String core_path=Variables.Drone_Path+"//"+found_data_in_config("LIB_FOLDER:{", "LIB_FOLDER];").get(0).get(0)+"//Config.h";
